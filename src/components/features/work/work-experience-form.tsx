...
export const WorkExperienceForm = ({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      {/* Submit */}
      <Button type="submit" disabled={isSubmitting} className="mt-4 w-full flex-1 font-bold transition-opacity hover:opacity-85" style={{ background: "#FFB902", color: "#04061a" }}>
        {isSubmitting ? (
          <>
